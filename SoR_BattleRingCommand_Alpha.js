//=============================================================================
// SoR_BattleRingCommand_Alpha.js
 ...
 */
/*:
* @plugindesc <Ring UI for Actor Command on Battle Type:Alpha>
...
*
* @param Ringbase_X-coordinate
* @desc x-coordinate (at upper right corner) of Base Ring sprite (default: 280)
* @default 280
* @type number
* @param Ringbase_Y-coordinate
* @desc y-coordinate (at upper right corner) of Base Ring sprite (default: 320)
* @default 320
* @type number
*
* @param --------------------------------
...
* @type number
* @param Ringover_Y-coordinate
* @desc y-coordinate of the upper layered ring sprite (default: 0)
* @default 0
* @type number
*
* @param CommandPadd_X-coordinate
* @desc Padding for x to align command icon on the ring (default: 128)
* @default 128
* @type number
* @param CommandPadd_Y-coordinate
* @desc Padding for y to align command icon on the ring (default: 128)
* @default 128
* @type number
*
* @param CommandName_X-coordinate
* @desc x-coordinate to draw command name for current command index (default: 40)
* @default 40
* @type number
* @param CommandName_Y-coordinate
* @desc y-coordinate to draw command name for current command index(default: 94)
* @default 94
* @type number
* @param CommandName_Width
* @desc Maximum width for the display of command names (default: 140)
* @default 140
* @type number
*
* @param RingCommands_Radius
...
var Param = PluginManager.parameters('SoR_BattleRingCommand_Alpha');
var Ringbase_X_coord = Number(Param['Ringbase_X-coordinate'] || 280);
var Ringbase_Y_coord = Number(Param['Ringbase_Y-coordinate'] || 320);
var Ringover_X_coord = Number(Param['Ringover_X-coordinate'] || 0);
var Ringover_Y_coord = Number(Param['Ringover_Y-coordinate'] || 0);
var CommandPadd_X_coord = Number(Param['CommandPadd_X-coordinate'] || 128);
var CommandPadd_Y_coord = Number(Param['CommandPadd_Y-coordinate'] || 128);
var CommandName_X_coord = Number(Param['CommandName_X-coordinate'] || 40);
var CommandName_Y_coord = Number(Param['CommandName_Y-coordinate'] || 94);
var CommandName_Width = Number(Param['CommandName_Width'] || 140);
...
function CreateCommandNameField(baseX,baseY){
	var namefield = new Window_Base(baseX,baseY,256,256);
